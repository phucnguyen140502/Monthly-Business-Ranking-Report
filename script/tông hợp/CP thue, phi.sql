...
/* CHI TIÊU CP thuế, phí */
------ tính tháng 2
select*from dim_structure ds ;

---- step 1: đổ dữ liệu CP thuế, phí chưa phân bảo vào temporary table

--- tính CP thuế, phí chưa phân bổ 
truncate table tmp_cp_thue_phi_chua_phan_bo ;
--- CP thuế, phí DVML
INSERT INTO tmp_cp_thue_phi_chua_phan_bo
...
select*from tmp_cp_thue_phi_chua_phan_bo tdkd ;
...
--- step 3: tính phân bổ CP thuế, phí
truncate table tmp_cp_thue_phi_da_phan_bo ;

INSERT INTO tmp_cp_thue_phi_da_phan_bo
...
from tmp_cp_thue_phi_chua_phan_bo x 
join tmp_cp_thue_phi_chua_phan_bo y
...
select*from tmp_cp_thue_phi_da_phan_bo tdkddpb ;
