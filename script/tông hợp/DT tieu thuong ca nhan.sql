...
/* CHI TIÊU DT tiểu thương, cá nhân */
------ tính tháng 2
select*from dim_structure ds ;

---- step 1: đổ dữ liệu DT tiểu thương, cá nhân chưa phân bảo vào temporary table

--- tính DT tiểu thương, cá nhân chưa phân bổ 
truncate table tmp_dt_tieu_thuong_ca_nhan_chua_phan_bo ;
--- DT tiểu thương, cá nhân DVML
INSERT INTO tmp_dt_tieu_thuong_ca_nhan_chua_phan_bo
...
select*from tmp_dt_tieu_thuong_ca_nhan_chua_phan_bo tdkd ;
...
--- step 3: tính phân bổ DT tiểu thương, cá nhân
truncate table tmp_dt_tieu_thuong_ca_nhan_da_phan_bo ;

INSERT INTO tmp_dt_tieu_thuong_ca_nhan_da_phan_bo
...
from tmp_dt_tieu_thuong_ca_nhan_chua_phan_bo x 
join tmp_dt_tieu_thuong_ca_nhan_chua_phan_bo y
...
select*from tmp_dt_tieu_thuong_ca_nhan_da_phan_bo tdkddpb ;
