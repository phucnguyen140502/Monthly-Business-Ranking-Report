...
---- step 1: đổ dữ liệu  DT Nguồn vốn  chưa phân bảo vào temporary table

--- tính  DT Nguồn vốn  chưa phân bổ 
truncate table tmp_cp_dt_nguon_von_chua_phan_bo;
---  DT Nguồn vốn  DVML
INSERT INTO tmp_cp_dt_nguon_von_chua_phan_bo
...
select*from tmp_cp_dt_nguon_von_chua_phan_bo;
---- step 2: tính phân bổ nhân viên sm
select*from temp_os_after_wo toaw ;

---- step 3: tính phân bổ  DT Nguồn vốn 
truncate table tmp_cp_dt_nguon_von_da_phan_bo;

INSERT INTO tmp_cp_dt_nguon_von_da_phan_bo
...
from tmp_cp_dt_nguon_von_chua_phan_bo x 
join tmp_cp_dt_nguon_von_chua_phan_bo y
...
select*from tmp_cp_dt_nguon_von_da_phan_bo ;
