...
---- step 1: đổ dữ liệu CP vốn TT 2 chưa phân bảo vào temporary table

--- tính CP vốn TT 2 chưa phân bổ 
truncate table tmp_cp_von_tt_2_chua_phan_bo;
--- CP vốn TT 2 DVML
INSERT INTO tmp_cp_von_tt_2_chua_phan_bo
...
select*from tmp_cp_von_tt_2_chua_phan_bo;
---- step 2: tính phân bổ nhân viên sm
select*from temp_os_after_wo toaw ;

---- step 3: tính phân bổ CP vốn TT 2
truncate table tmp_cp_von_tt_2_da_phan_bo;

INSERT INTO tmp_cp_von_tt_2_da_phan_bo
...
from tmp_cp_von_tt_2_chua_phan_bo x 
join tmp_cp_von_tt_2_chua_phan_bo y
...
select*from tmp_cp_von_tt_2_da_phan_bo ;
