...
truncate table tmp_dt_kinh_doanh_chua_phan_bo_sale_manager ;

INSERT INTO tmp_dt_kinh_doanh_chua_phan_bo_sale_manager
...
select*from tmp_dt_kinh_doanh_chua_phan_bo_sale_manager tlqhcpbsm ;
...
select a.month_key , a.region_code, a.area_name, a.email 
, a.avg_dbgroup_after_wo  , b.avg_dbgroup_after_wo as avg_dbgroup_after_wo_head
...
truncate table tmp_dt_kinh_doanh_da_phan_bo_sale_manager ;

INSERT INTO tmp_dt_kinh_doanh_da_phan_bo_sale_manager
...
from tmp_dt_kinh_doanh_chua_phan_bo_sale_manager x 
join tmp_dt_kinh_doanh_chua_phan_bo_sale_manager y 
...
select*from tmp_dt_kinh_doanh_da_phan_bo_sale_manager tlqhdpbsm ;
