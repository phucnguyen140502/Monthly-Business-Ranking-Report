...
truncate table tmp_lai_qua_han_chua_phan_bo_sale_manager ;

INSERT INTO tmp_lai_qua_han_chua_phan_bo_sale_manager
...
select*from tmp_lai_qua_han_chua_phan_bo_sale_manager tlqhcpbsm ;

---- step 2: đổ dữ liệu vào 
--- tính dư nơ cuối kì trung bình sau wo nhóm 2 (max_bucket vào region_code)
truncate table temp_os_after_wo_2_sale_manager ;

INSERT INTO temp_os_after_wo_2_sale_manager
...
select*from temp_os_after_wo_2_sale_manager toawsm ;

---- step 3: đổ data vào tính amount đã phân bổ
truncate table tmp_lai_qua_han_da_phan_bo_sale_manager ;

INSERT INTO tmp_lai_qua_han_da_phan_bo_sale_manager
...
from tmp_lai_qua_han_chua_phan_bo_sale_manager x 
join tmp_lai_qua_han_chua_phan_bo_sale_manager y 
...
(
	...
	from temp_os_after_wo_2_sale_manager a 
	join temp_os_after_wo_2_sale_manager b 
...
select*from tmp_lai_qua_han_da_phan_bo_sale_manager tlqhdpbsm ;
