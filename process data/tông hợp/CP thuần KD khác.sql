...
---- step 1: đổ dữ liệu CP thuần KD khác chưa phân bảo vào temporary table

--- tính CP thuần KD khác chưa phân bổ 
truncate table tmp_cp_thuan_kd_khac_chua_phan_bo ;
--- CP thuần KD khác DVML
INSERT INTO tmp_cp_thuan_kd_khac_chua_phan_bo
...
select*from tmp_cp_thuan_kd_khac_chua_phan_bo tdkd ;
...
--- step 3: tính phân bổ CP thuần KD khác
truncate table tmp_cp_hoa_hong_da_phan_bo ;

INSERT INTO tmp_cp_hoa_hong_da_phan_bo
...
from tmp_cp_thuan_kd_khac_chua_phan_bo x 
join tmp_cp_thuan_kd_khac_chua_phan_bo y
...
select*from tmp_cp_hoa_hong_da_phan_bo tdkddpb ;
