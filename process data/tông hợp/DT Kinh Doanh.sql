...
---- step 1: đổ dữ liệu DT Kinh Doanh chưa phân bảo vào temporary table

--- tính DT Kinh Doanh chưa phân bổ 
truncate table tmp_dt_kinh_doanh_chua_phan_bo ;
--- DT Kinh Doanh DVML
INSERT INTO tmp_dt_kinh_doanh_chua_phan_bo
...
select*from tmp_dt_kinh_doanh_chua_phan_bo tdkd ;
...
--- step 3: tính phân bổ DT Kinh Doanh
truncate table tmp_dt_kinh_doanh_da_phan_bo ;

INSERT INTO tmp_dt_kinh_doanh_da_phan_bo
...
from tmp_dt_kinh_doanh_chua_phan_bo x 
join tmp_dt_kinh_doanh_chua_phan_bo y
...
select*from tmp_dt_kinh_doanh_da_phan_bo tdkddpb ;
