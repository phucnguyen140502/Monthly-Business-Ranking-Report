...
---- step 1: đổ dữ liệu DT Fintech chưa phân bảo vào temporary table

--- tính DT Fintech chưa phân bổ 
truncate table tmp_dt_fintech_chua_phan_bo ;
--- DT Fintech DVML
INSERT INTO tmp_dt_fintech_chua_phan_bo
...
select*from tmp_dt_fintech_chua_phan_bo tdkd ;
...
--- step 3: tính phân bổ DT Fintech
truncate table tmp_dt_fintech_da_phan_bo ;

INSERT INTO tmp_dt_fintech_da_phan_bo
...
from tmp_dt_fintech_chua_phan_bo x 
join tmp_dt_fintech_chua_phan_bo y
...
select*from tmp_dt_fintech_da_phan_bo tdkddpb ;
