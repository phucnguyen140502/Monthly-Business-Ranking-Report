/* CHI TIÊU CP vốn TT 1 */
------ tính tháng 2
select*from dim_structure ds ; 
--- tính tổng thu nhập hoạt động từ thẻ vay ĐVML
---- step 1: đổ dữ liệu CP vốn TT 1 chưa phân bảo vào temporary table

--- tính CP vốn TT 1 chưa phân bổ 
truncate table tmp_cp_von_tt_1_chua_phan_bo;
--- CP vốn TT 1 DVML
INSERT INTO tmp_cp_von_tt_1_chua_phan_bo
...
select*from tmp_cp_von_tt_1_chua_phan_bo;
---- step 2: tính phân bổ nhân viên sm
select*from temp_os_after_wo toaw ;

---- step 3: tính phân bổ CP vốn TT 1
truncate table tmp_cp_von_tt_1_da_phan_bo;

INSERT INTO tmp_cp_von_tt_1_da_phan_bo
...
from tmp_cp_von_tt_1_chua_phan_bo x 
join tmp_cp_von_tt_1_chua_phan_bo y
...
select*from tmp_cp_von_tt_1_da_phan_bo ;
