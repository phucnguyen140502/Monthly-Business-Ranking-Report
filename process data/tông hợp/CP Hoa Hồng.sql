...
---- step 1: đổ dữ liệu CP Hoa Hồng chưa phân bảo vào temporary table

--- tính CP hoa hồng chưa phân bổ 
truncate table tmp_cp_hoa_hong_chua_phan_bo ;
--- CP hoa hồng DVML
INSERT INTO tmp_cp_hoa_hong_chua_phan_bo
...
select*from tmp_cp_hoa_hong_chua_phan_bo tdkd ;
...
--- step 3: tính phân bổ CP hoa hồng
...
from tmp_cp_hoa_hong_chua_phan_bo x 
join tmp_cp_hoa_hong_chua_phan_bo y
